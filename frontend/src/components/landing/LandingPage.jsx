  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-cyan-500/10 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <nav className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold text-white">StockMaster</div>
            ...
            <div className="hidden gap-8 md:flex text-sm">
              ...
              <a href="#workflows" className="text-slate-300 hover:text-white transition-colors">Workflows</a>
              <a href="#benefits" className="text-slate-300 hover:text-white transition-colors">Benefits</a>
            </div>
            <div className="flex items-center gap-3">
              <Link to="/login" className="rounded-xl px-5 py-2.5 text-sm font-medium text-slate-300 hover:text-white transition-colors">
                Sign In
              </Link>
          ...
          <div className="mt-20 pb-20 grid gap-16 lg:grid-cols-2 lg:items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-2 rounded-full border border-primary-500/30 bg-primary-500/10 px-4 py-2 text-sm font-medium text-primary-300 backdrop-blur-sm">
              ...
              <div className="mt-10 flex flex-wrap gap-4 justify-center lg:justify-start">
                ...
                <Link 
                  to="/login" 
                  className="inline-flex items-center gap-2 rounded-xl border-2 border-white/20 bg-white/5 px-8 py-4 text-lg font-semibold text-white backdrop-blur-sm hover:bg-white/10 transition-all"
                >
                  View Demo
                </Link>
              </div>
              <div className="mt-12 flex flex-wrap gap-6 text-sm text-slate-400 justify-center lg:justify-start">
            ...
            <div className="relative">
              <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 shadow-2xl backdrop-blur-xl">
                <div className="flex items-center justify-between mb-6">
                  <div className="text-lg font-semibold text-white">Live Dashboard Preview</div>
                ...
                <div className="space-y-4">
                  {stats.map((stat, index) => {
                    ...
                    return (
                      <div 
                        key={stat.label} 
                        className="group rounded-2xl border border-white/10 bg-gradient-to-br from-slate-700/30 to-slate-800/30 p-6 hover:border-primary-500/50 transition-all hover:scale-[1.02]"
                ...
                <div className="mt-6 rounded-2xl border border-primary-500/20 bg-primary-500/10 p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm font-medium text-white">"StockMaster eliminated all our tracking errors and saved us 4 hours every day!"</div>
                      <div className="mt-2 text-xs text-slate-400">— Operations Manager, TechRetail Co.</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <main className="relative bg-slate-900">
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {features.map((feature, index) => {
                ...
                return (
                  <div 
                    key={feature.title} 
                    className="group relative rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 backdrop-blur-sm hover:border-primary-500/50 transition-all hover:scale-[1.02] hover:shadow-2xl hover:shadow-primary-500/20"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    ...
                    <div className="mt-1 inline-flex rounded-full bg-white/5 px-3 py-1 text-xs font-medium text-slate-400">
                      {feature.badge}
                    </div>
                    <h3 className="mt-4 text-xl font-bold text-white group-hover:text-primary-300 transition-colors">
                      {feature.title}
                    </h3>
        ...
        {/* Benefits Section */}
        <section id="benefits" className="relative py-24 bg-gradient-to-br from-slate-950 to-slate-900">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <div className="mt-10 space-y-4">
                  {benefits.map((benefit, index) => (
                    <div 
                      key={index} 
                      className="flex items-center gap-4 text-lg text-slate-300 group"
                      style={{ animationDelay: `${index * 0.1}s` }}
                    >
              ...
              <div className="relative">
                <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 backdrop-blur-xl">
                  <div className="space-y-6">
                    <div className="rounded-2xl border border-green-500/20 bg-green-500/10 p-6">
                      <div className="flex items-center gap-3 mb-4">
                        <Database className="h-6 w-6 text-green-400" />
                        <div className="text-sm font-medium text-green-300">Stock Operations</div>
                      </div>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-slate-300">Today's Receipts</span>
                          <span className="font-bold text-white">145 items</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-slate-300">Pending Deliveries</span>
                          <span className="font-bold text-white">23 orders</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-slate-300">Active Transfers</span>
                          <span className="font-bold text-white">8 transfers</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-blue-500/20 bg-blue-500/10 p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="text-sm font-medium text-blue-300">Investment Insights</div>
                      </div>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-slate-300">Total Inventory Value</span>
                          <span className="font-bold text-white">$248,500</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                        ...
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-slate-300">ROI This Quarter</span>
                    ...
                    <div className="rounded-2xl border border-purple-500/20 bg-purple-500/10 p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="text-sm font-medium text-purple-300">Live Alerts</div>
                      </div>
        ...
        {/* Workflows Section */}
        <section id="workflows" className="relative py-24 bg-slate-900">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {workflows.map((flow, index) => {
                ...
                return (
                  <div 
                    key={flow.title} 
                    className="group relative rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800/80 to-slate-900/80 p-8 backdrop-blur-sm hover:border-cyan-500/50 transition-all hover:scale-[1.05] hover:shadow-2xl hover:shadow-cyan-500/20"
                  ...
                  >
                    <div className="flex items-start justify-between mb-6">
                      ...
                      <div className="text-5xl font-bold text-white/5 group-hover:text-white/10 transition-colors">
                        0{index + 1}
                      </div>
                    </div>
                    ...
                    <p className="text-slate-400 text-sm mb-6">{flow.description}</p>
                    ...
                    <div className="mt-8 h-1 w-full rounded-full bg-slate-700/50 overflow-hidden">
            ...
            <div className="mt-16 rounded-3xl border border-primary-500/30 bg-gradient-to-r from-primary-500/10 via-purple-500/10 to-pink-500/10 p-8 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <Link 
                  to="/register" 
                  className="rounded-xl bg-white px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-slate-100 transition-colors flex-shrink-0"
                >
        ...
        {/* CTA Section */}
        <section id="cta" className="relative py-24 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          ...
          <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-12 md:p-16 text-center backdrop-blur-xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-green-500/30 bg-green-500/10 px-4 py-2 text-sm font-medium text-green-300 backdrop-blur-sm mb-8">
                <Zap className="h-4 w-4" />
                Ready in 5 Minutes
              </div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Link 
                  to="/login" 
                  className="inline-flex items-center gap-3 rounded-xl border-2 border-white/20 bg-white/5 px-10 py-5 text-lg font-semibold text-white backdrop-blur-sm hover:bg-white/10 transition-all"
                >
                  Sign In
                </Link>
              </div>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-lg font-bold text-white">StockMaster</div>
                  <div className="text-xs text-slate-400">by Odoo Hacks</div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-slate-400">
                ...
                <a href="#workflows" className="block hover:text-white transition-colors">Workflows</a>
                <a href="#benefits" className="block hover:text-white transition-colors">Benefits</a>
                <Link to="/register" className="block hover:text-white transition-colors">Pricing</Link>
              </div>
            </div>
